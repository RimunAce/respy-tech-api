...
import { chatCompletionsLimiter, modelsLimiter } from '../config/rateLimit';
...
// Chat completions route
router.post('/chat/completions', validateApiKey, chatCompletionsLimiter, asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
  try {
...
// List models route
router.get('/models', modelsLimiter, asyncHandler(async (req: Request, res: Response) => {
